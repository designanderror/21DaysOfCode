...
() => {
  set(['.bear__mouth--tired', '.bear__eyes--tired', '.bear__mouth--sad', '.eyes--normal', '.bear__brows'], {
    display: 'none' });
...
() => {
  SOB_TL.reverse();
  set(['.bear__eyes--tired', '.bear__brows', '.bear__mouth--tired'], { display: 'block' });
  set(['.bear__sob-eye', '.eyes--normal', '.bear__mouth--sobbing'], { display: 'none' });
}];
...
const Bear = ({ dirty, remaining }) => {
  ...
  return (
    React.createElement("svg", { className: "bear", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("g", { className: "bear__head" },
    ...
    React.createElement("path", { d: "M192 200c0 10-26 33-41 33s-43-23-43-33 27-17 42-17 42 7 42 17z" }),
    React.createElement("ellipse", { cx: "40.4", cy: "60.3", rx: "31.9", ry: "31", fill: "#803300" }),
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__mouth" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__mouth--smile" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__mouth--straight" },
    React.createElement("path", {
      d: "M116 260v0h68",
      fill: "none",
      stroke: "#000",
    ...
    React.createElement("g", { className: "bear__sweat" },
    React.createElement("path", {
      d: "M251 108a13 13 0 11-25 0c0-7 6-25 13-25s12 18 12 25z",
      fill: "#0ff" })),


    React.createElement("g", { className: "bear__tear" },
    React.createElement("path", {
      d: "M63 191a13 13 0 11-25 0c0-7 5-24 12-24s13 17 13 24z",
      fill: "#0ff" })),


    React.createElement("g", { className: "bear__cheeks" },
    React.createElement("circle", { cx: "59.6", cy: "191.3", r: "17.2", fill: "#faa" }),
    React.createElement("circle", { r: "17.2", cy: "191.3", cx: "238.2", fill: "#faa" })),

    React.createElement("g", { className: "eyes eyes--smiley" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__brows" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "eye__whites" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "eyes eyes--normal" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__mouth--sad" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__mouth--sobbing" },
    ...
    React.createElement("g", { className: "eyes--sobbing" },
    React.createElement("path", {
      d: "M68 149h23",
      fill: "none",
      stroke: "#000",
    ...
    React.createElement("g", { className: "bear__mouth--tired" },
    React.createElement("path", {
      d: "M199 273a51 46 0 00-49-33 51 46 0 00-49 33 70 51 0 0149-14 70 51 0 0149 14z",
      stroke: "#000",
      strokeLinecap: "round",
    ...
    React.createElement("g", { className: "bear__eyes--tired" },
    React.createElement("path", {
    ...
    React.createElement("g", { className: "bear__face bear__face--tired" },
    React.createElement("path", {
      d: "M64 148a15 15 0 000 1 15 15 0 0015 15 15 15 0 0015-15 15 15 0 00-2-8 15 15 0 010 1 15 15 0 01-1 1 15 15 0 010 2 15 15 0 010 1 15 15 0 01-1 1 15 15 0 01-1 2 15 15 0 01-1 1 15 15 0 01-1 1 15 15 0 01-1 1 15 15 0 01-1 1 15 15 0 01-1 0 15 15 0 01-2 1 15 15 0 01-1 1 15 15 0 01-2 0 15 15 0 01-1 0 15 15 0 01-1 0 15 15 0 01-2 0 15 15 0 01-1 0 15 15 0 01-2-1 15 15 0 01-1 0 15 15 0 01-1-1 15 15 0 01-2-1 15 15 0 01-1 0 15 15 0 01-1-1 15 15 0 01-1-2 15 15 0 01-1-1z",
      fillOpacity: ".9" }),
...
const Todo = ({ id, label, complete, toggleComplete, onRemove, style }) => {
  return (
    React.createElement("li", { className: "notepad__item", style: style },
...
const App = () => {
  ...
  return (
    ...
    React.createElement("form", { className: "notepad", onSubmit: addTodo },
    React.createElement("div", { className: "notepad__header" },
    new Array(5).fill().map((ring, index) =>
    React.createElement("div", { key: `ring--${index}`, className: "notepad__ring" }))),
    ...
    React.createElement("ul", { className: "notepad__items" },


    state.dirty &&
    state.completion === 1 &&
    state.todos.length === 0 && React.createElement("h1", null, "You did it!"),
    state.todos.map(todo => {
      return (
...
render(React.createElement(App, null), ROOT_NODE);